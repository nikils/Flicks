...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    topRatedViewController.title = topRatedNavigationController.title;
    ...
    nowPlayingNavigationController.tabBarItem.image = [UIImage imageNamed:@"movie.png"];
    nowPlayingController.title = nowPlayingNavigationController.title;
